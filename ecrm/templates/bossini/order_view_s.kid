...
<div class="nav-tree">Bossini&nbsp;&nbsp;&gt;&nbsp;&nbsp;Main&nbsp;&nbsp;&gt;&nbsp;&nbsp;Style Printed Label (款号唛)</div>
<div style="width:1200px;">
	...
	<!--  main content begin -->		
		  ...
		  <table width="100%" cellspacing="0" cellpadding="0" bordercolor="#000000" border="1">
		    <tbody><tr>
		      <td class="color-000000"><table width="100%" cellspacing="1" cellpadding="0" border="0">
		        <tbody>
		        <tr>
		          <td class="STYLE18 color-CCFFCC" colspan="2" align="center">Style Printed Label (款号唛)</td>
		        </tr>
		        <tr>
		        ...
		        <tr>
		          ...
		          <td class="STYLE19 color-FFFFFF"><span>${slInfo.item.itemCode}</span>&nbsp;</td>
		        </tr>
		        
		        <?python
		        	totalQty = sum([d.qty for d in slInfo.getDetails()])
		        ?>
		        
		        <tr>
		        	<td class="STYLE18 color-CCFFCC">Reference Total Order Price (before VAT)<br/>参考税前单价（运费除外）:</td>
		        	<td class="STYLE19 color-FFFFFF">
		        		<div id="amt_div" py:if="order.currency=='HKD'" py:strip="">&nbsp;$ ${slInfo.item.hkPrice} <b>X</b> ${totalQty} <b>=</b> $ ${"%.6f" %(totalQty*slInfo.item.hkPrice)}</div>
		        		<div id="amt_div" py:if="order.currency=='RMB'" py:strip="">&nbsp;￥ ${slInfo.item.rmbPrice} <b>X</b> ${totalQty} <b>=</b> ￥ ${"%.6f" %(totalQty*slInfo.item.rmbPrice)}</div>
		        	</td>
		        </tr>
		        <tr>
		          ...
		          <td class="STYLE19 color-FFFFFF">
		          	<table cellspacing="0" cellpadding="0" border="0">
		          		<tr py:for="lc in  slInfo.getDetails()">
		          			<td width="200">&nbsp;${lc.legacyCode}</td>
		          			<td>${lc.qty}PCS</td>
		          		</tr>
		          		<tr>
		          			<td>&nbsp;</td>
		          			<td><b>Total ${totalQty} PCS</b></td>
		          		</tr>
		          	</table>
				  </td>
		        </tr>
		...
		<div style="float:left;width:200px;margin-left:50px;margin-top:15px">
			<div><a href="#itemImg" class="photo"><img class="hangTagImg" src="/static/images/bossini/${slInfo.item.itemCode}.jpg" width="190"/></a></div>
			<div id="itemImg"><img class="hangTagImg" src="/static/images/bossini/${slInfo.item.itemCode}.jpg"/></div>
		</div>
