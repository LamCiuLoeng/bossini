...
<head>
    ...
    <script src="/static/javascript/custom/bossini_input_fc.js" language="javascript"></script>
...
<div style="width:1200px;">
	...
	<!--  main content begin -->	
	<form action="/bossinipo/saveFunctionCardOrder" method="POST">
		<input type="hidden" name="orderType" value="F"/>
		        ...
		        <tr>
		          ...
		          <td class="STYLE19 color-FFFFFF">
					<select name="item" id="item"  style="width:300px">
						<option value=""></option>
						<option py:for="item in items" value="${item.id}" rmbprice="${item.rmbPrice}" hkprice="${item.hkPrice}">${item.itemCode}</option>
					</select>
				  </td>
		        </tr>
		        <tr>
		...
		<div style="float:left;width:200px;margin-left:50px;margin-top:15px">
			<div><a href="#itemImg" class="photo"><img class="hangTagImg" src="/static/images/blank.png" height="190"/></a></div>
