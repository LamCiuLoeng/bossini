...
<div class="nav-tree">Bossini&nbsp;&nbsp;&gt;&nbsp;&nbsp;Main&nbsp;&nbsp;&gt;&nbsp;&nbsp;Country of Origin (产地唛)</div>
<div style="width:1200px;">
	...
	<!--  main content begin -->		
		  ...
		  <table width="100%" cellspacing="0" cellpadding="0" bordercolor="#000000" border="1">
		    <tbody><tr>
		      <td class="color-000000"><table width="100%" cellspacing="1" cellpadding="0" border="0">
		        <tbody>
		        <tr>
		          <td class="STYLE18 color-CCFFCC" colspan="2" align="center">Country of Origin (产地唛)</td>
		        </tr>
		        <tr>
		        ...
		        <tr>
		          ...
		          <td class="STYLE19 color-FFFFFF"><span>${coInfo.item.display} (${coInfo.item.component})</span>&nbsp;</td>
		        </tr>
		        <tr>
		          <td class="STYLE18 color-CCFFCC"><label for="qty">Total this order Quantity (pieces) 这一个订单贵司采购的个数 :</label></td>
		          <td class="STYLE19 color-FFFFFF"><span>${coInfo.qty}</span>&nbsp;</td>
		        </tr>
		        <tr>
		        	<td class="STYLE18 color-CCFFCC">Reference Total Order Price (before VAT)参考税前单价（运费除外）</td>
		        	<td class="STYLE19 color-FFFFFF">
		        		<div id="amt_div" py:if="order.currency=='HKD'" py:strip="">&nbsp;$ ${coInfo.item.hkPrice} <b>X</b> ${coInfo.qty} <b>=</b> $ ${"%.6f" %(coInfo.qty*coInfo.item.hkPrice)}</div>
		        		<div id="amt_div" py:if="order.currency=='RMB'" py:strip="">&nbsp;￥ ${coInfo.item.rmbPrice} <b>X</b> ${coInfo.qty} <b>=</b> ￥ ${"%.6f" %(coInfo.qty*coInfo.item.rmbPrice)}</div>
		        	</td>
		        </tr>
		        <tr>
		          ...
		          <td class="STYLE19 color-FFFFFF">
		          	<table cellspacing="0" cellpadding="0" border="0">
		          		<tr py:for="lc in  coInfo.getDetails()">
		          			<td>&nbsp;${lc.legacyCode}</td>
		          		</tr>
		          	</table>
				  </td>
		...
		<div style="float:left;width:200px;margin-left:50px;margin-top:15px">
			<div><a href="#itemImg" class="photo"><img class="hangTagImg" src="/static/images/bossini/${coInfo.item.img}.jpg" width="190"/></a></div>
			<div id="itemImg"><img class="hangTagImg" src="/static/images/bossini/${coInfo.item.img}.jpg"/></div>
		</div>
