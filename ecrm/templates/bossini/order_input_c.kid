...
<head>
    ...
    <script src="/static/javascript/jquery.bgiframe.pack.js" language="javascript"></script>
    ...
    <script src="/static/javascript/custom/bossini_input_c.js" language="javascript"></script>
...
<div style="width:1200px;">
	...
	<!--  main content begin -->	
	<form action="/bossinipo/saveCOOrder" method="POST">
		<input type="hidden" name="orderType" value="CO"/>
		        ...
		        <tr>
		          ...
		          <td class="STYLE19 color-FFFFFF">
					<select name="item" id="item"  style="width:300px">
						<option value=""></option>
						<option py:for="item in items" value="${item.id}" itemCode="${item.img}" rmbprice="${item.rmbPrice}" hkprice="${item.hkPrice}">${item.display}  (${item.component})</option>
					</select>
				  </td>
		        </tr>
		        <tr>
		...
		<div style="float:left;width:200px;margin-left:50px;margin-top:15px">
			<div><a href="#itemImg" class="photo"><img class="hangTagImg" src="/static/images/blank.png" width="190"/></a></div>
