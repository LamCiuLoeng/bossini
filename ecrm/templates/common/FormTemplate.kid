        ...
        <div>
            <div class="case-list-one" py:for="group in groups" py:attrs="table_attrs">
                <ul py:for="field in group">
                    ...
                    <!-- <li py:if="hasattr(field,'CustomerWidget')">${value_for(field)}</li> -->
                    <li py:if="not hasattr(field,'CustomerWidget')"><span py:replace="field.display(value_for(field), **params_for(field))" /></li>
