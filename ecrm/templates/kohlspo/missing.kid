...
<head>
	...
	<script src="/static/javascript/custom/kohls_missing.js" language="javascript"></script>
...
<div id="function-menu">
  ...
  <tbody><tr>
    ...
    <td width="64" valign="top" align="left"><a href="/kohlspo/index"><img src="/static/images/images/menu_kohls_g.jpg"/></a></td>
	<td width="64" valign="top" align="left"><a href="javascript:addPO()"><img height="21" src="/static/images/images/menu_addpo-g.jpg"/></a></td>
    <td width="23" valign="top" align="left"><img height="21" src="/static/images/images/menu_last.jpg"/></td>
    <td align="left" valign="top" background="/static/images/images/menu_end.jpg">&nbsp;</td>
		...
		<div class="case-list-four" style="display:none" id="addDiv">
			<form action="/kohlspo/addPO" method="post" name="addForm">
			<input type="hidden" name="header_id" value="test"/>
		        <ul>
		            <li class="label">PO NO</li>
		            <li><input type="text" value="" name="po_no" style="width:200px"/></li>
		        </ul>
		        <ul>
		            <li class="label">SO NO</li>
		            <li><input type="text" value="" name="so_no" style="width:200px"/></li>
		        </ul>
		        <ul>
		            <li class="label">SO Remark</li>
		            <li><input type="text" value="" name="remark" style="width:200px"/></li>
		        </ul>
		        <ul>
