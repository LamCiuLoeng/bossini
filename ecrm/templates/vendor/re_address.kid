...
//<![CDATA[
	...
	if($(".recordForm  tbody :checked").length !=1){
		...
		f.attr("action","/vendor/reviseShipTo");
		f.submit();		
	}
...
<div style="width:1200px;">
	<div style="overflow:hidden;margin:10px 0px 10px 0px">
		<div class="case-960-one">
			...
			<a href="#" onclick="revise_ship_to();"><img src="/static/images/images/revise.jpg" /></a>
			...
			<a href="/vendor/history?id=${vendor_id}"><img src="/static/images/images/_history_g.jpg" /></a>
				...
				<div class="log-one">Ship To Information for vendor ${obj.vendorCode}</div>
					<form action="/vendor/saveShipTo">
						...
						<div class="case-list-one">
			                <ul>
			                    ...
			                    <li>
			                    	<input type="text" name="shipTo" id="shipTo" value="" class="editContent" style="width:250px"/>
			                    </li>
			                </ul>
			            	<ul>
					...
					<ul>
			            ...
			            <div class="case-list-one">
			                ...
			                <ul>
			                    ...
			                    <li>
			                    	<input type="text" name="email" id="email" value="" class="editContent" style="width:250px"/></li>
			                </ul>
			                <ul>
			                    <li class="label"><label>Sample Receiver</label></li>
			                    <li>
			                    	<input type="text" name="sampleReceiver" id="sampleReceiver" value=""  class="editContent" style="width:250px"/></li>
			                </ul>
					<ul>
			                    <li class="label"><label>Sample Send Address</label></li>
			                    <li>
			                    	<input type="text" name="sampleSendAddress" id="sampleSendAddress" value=""  class="editContent" style="width:250px"/></li>
			                </ul>
			            </div>
			            <br style="clear:both;"/>
		    </form>
