	...
	<div style="overflow:hidden;margin:10px 0px 10px 0px">
		<div class="case-960-one" id="${'div-%s' % vendor_id}">
			...
			<a href="/vendor/history?id=${vendor_id}"><img src="/static/images/images/_history_g.jpg" /></a>
				...
				<div class="log-one">Ship Address Information</div>
					...
					<div class="case-list-one">
			                <ul>
			                    ...
			                    <li>
			                    	<input type="text" name="companyName" value="${obj.companyName}"  style="width:250px" readonly="${can_edit}"/>
			                    </li>
			                </ul>
			            	<ul>
			                    <li class="label"><label>Address(Ship to)</label></li>
			                    <li>
			                    	<input type="text" name="address" value="${obj.address}" style="width:250px" readonly="${can_edit}"/></li>
			                </ul>
			                <ul>
			                    <li class="label"><label>Contact person</label></li>
			                    <li>
			                    	<input type="text" name="contact" value="${obj.contact}"  style="width:250px"  readonly="${can_edit}"/></li>
			                </ul>
			                <ul>
			                    <li class="label"><label>Contact telephone</label></li>
			                    <li>
			                    	<input type="text" name="tel" value="${obj.tel}" style="width:250px"  readonly="${can_edit}"/></li>
			                </ul>
			            </div>
			            <div class="case-list-one">
			                <ul>
			                    ...
			                    <li>
			                    	<input type="text" name="VATInfo" value="${obj.VATInfo}" style="width:250px"  readonly="${can_edit}"/></li>
			                </ul>
			                <ul>
			                    <li class="label"><label>Need Invoice</label></li>
			                    <li>
			                    	<input type="text" name="invoiceInfo" value="${obj.invoiceInfo}" style="width:250px" readonly="${can_edit}"/></li>
			                </ul>
			                <ul>
			                    <li class="label"><label>Special requirement</label></li>
			                    <li>
			                    	<input type="text" name="requirement" value="${obj.requirement}"  style="width:250px" readonly="${can_edit}"/></li>
			                </ul>
			            </div>
			            <br style="clear:both;"/>
					</form>
