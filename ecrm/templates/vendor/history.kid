...
<div style="width:1200px;">
	<div style="overflow:hidden;margin:10px 0px 10px 0px">
		<div class="case-960-one">
			...
			<a href="/vendor/review?id=${vendor_id}"><img src="/static/images/images/_save_g.jpg" /></a>
			<a href="/vendor/history?id=${vendor_id}"><img src="/static/images/images/_history_g.jpg" /></a>
			</div>
			<div class="log-one">History Information</div>
			<div class="case-list-one">
				        <ul><li class="label">Vendor</li><li>${POHeader.vendorCode}</li></ul>
				       
			</div>
			<div class="case-list-one">
				     <ul><li class="label">Vendor Name</li><li>${POHeader.vendorCode}</li></ul>
			</div>
		    <div class="case-900-one">
