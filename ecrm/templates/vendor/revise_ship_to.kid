	...
	<div style="overflow:hidden;margin:10px 0px 10px 0px">
		<div class="case-960-one">
			...
			<a href="#" onclick="toSave()"><img src="/static/images/images/_save_g.jpg" /></a>
				...
				<div class="log-one">Ship To Information</div>
					<form action="/vendor/updateShipTo">
						<input type="hidden" name="vendor_id" value="${vendor_id}"/>
						<input type="hidden" name="ship_id" value="${obj.id}"/>
						<input type="hidden" name="update" value="update"/>
						<div class="case-list-one">
			                <ul>
			                    <li class="label"><label>Company name</label></li>
			                    <li>
			                    	<input type="text" name="shipTo" id="shipTo" value="${obj.shipTo}" class="editContent" style="width:250px"/>
			                    </li>
			                </ul>
			            	<ul>
					...
					<ul>
			            ...
			            <div class="case-list-one">
			                ...
			                <ul>
			                    ...
			                    <li>
			                    	<input type="text" name="email" id="email" value="${obj.email}" class="editContent" style="width:250px"/></li>
			                </ul>
			                <ul>
			                    <li class="label"><label>Sample Receiver</label></li>
			                    <li>
			                    	<input type="text" name="sampleReceiver" id="sampleReceiver" value="${obj.sampleReceiver}"  class="editContent" style="width:250px"/></li>
			                </ul>
					<ul>
			                    <li class="label"><label>Sample Send Address</label></li>
			                    <li>
			                    	<input type="text" name="sampleSendAddress" id="sampleSendAddress" value="${obj.sampleSendAddress}"  class="editContent" style="width:250px"/></li>
			                </ul>
			            </div>
			            <br style="clear:both;"/>
		    </form>
