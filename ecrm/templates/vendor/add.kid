...
//<![CDATA[
    ...
    function toSave(){
	var companyname = $("#form_vendorCode").val();
	if(companyname==""){
	    alert("Please enter company name and billTo and shipTo at least!");
	    return false;	
	}
    	$('form').submit();
    }
...
<div class="nav-tree">Master&nbsp;&nbsp;&gt;&nbsp;&nbsp;Vendor&nbsp;&nbsp;&gt;&nbsp;&nbsp;New</div>
<div style="width:1200px;">
	<div style="overflow:hidden;margin:10px 0px 10px 0px">
		<div class="case-960-one">
			<div class="log-one">New Vendor Information</div>
